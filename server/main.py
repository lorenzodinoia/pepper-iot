...
try:
    ...
    cursor.execute("CREATE TABLE emergency (id INT AUTO_INCREMENT PRIMARY KEY, level_em INT, type_em INT, env_data_id INT, vital_signs_id INT, bed_id INT, CONSTRAINT fk_env_emergency FOREIGN KEY (env_data_id) REFERENCES environmental_data(id), CONSTRAINT fk_vital_signs_emergency FOREIGN KEY (vital_signs_id) REFERENCES vital_signs(id), CONSTRAINT fk_bed_emergency FOREIGN KEY (bed_id) REFERENCES bed(id))")
